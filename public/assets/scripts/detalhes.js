...
function adicionarDetalhes(filme) {
    ...
    // @ts-ignore
    let html_thumb = document.getElementById("thumb");
    /** @type {HTMLDivElement | null} */
    // @ts-ignore
    let html_thumb_background = document.getElementById("thumbBackground");

    let html_titulo = document.getElementById("titulo");
    let html_nota = document.getElementById("nota");
    let html_genero = document.getElementById("genero");
    let html_data_lancamento = document.getElementById("data_lancamento");
    let html_sinopse = document.getElementById("sinopse");
    ...
    if (Array.isArray(extraContent) && extraContent.length) {
        ...
        let html_extraContentHeader = document.getElementById("extraContentHeader");
        let html_extraContent = document.getElementById("extraContent");
